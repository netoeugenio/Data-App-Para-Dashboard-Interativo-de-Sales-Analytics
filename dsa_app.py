...
st.set_page_config(
    page_title="Data Science Academy Eugenio ",  # Título que aparece na aba do navegador
...
def dsa_filtros_sidebar(df):
    ...
    with st.sidebar.expander("🆘 Suporte / Fale conosco", expanded = False):
        st.write("Se tiver dúvidas envie mensagem para eugeniopaiva67@gmail.com")
...
def dsa_set_custom_theme():
    ...
    border_color = "#334155"    # Azul petróleo (bordas)
